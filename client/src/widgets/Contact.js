...
function Contact(){
    ...
    return(
        <div id="contact_div" style={masterStyles} className="d-flex flex-column justify-content-center align-self-center">
            <div className="d-flex flex-row justify-content-center">
                <img id="img_contact" className="mx-1" style={imgStyles} src={require("../assets/contactMe.jpg")}></img>
                <div id="contact_panel" className="d-flex flex-column justify-content-evenly align-items-center" style={infoStyles}>
                    <h1>Contact Yang</h1>
                    <br></br>
